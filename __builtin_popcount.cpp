// Before we describe this function, can you think of a solution to 
//the problem: “Count Set bits in a given integer?“, In simple words, 
//count the number of bit positions in binary representation of an integer which is set to 1?
